...
config_parser_test:
	...
	$(CC) $(TCFLAGS) -std=c++0x -isystem ${GTEST_DIR}/include $(TEST).cc $(TEST_SRC) ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LIBFLAGS) -o $(TEST)

# Remake unit tests for Serve 2.0
server_test:
	$(CC) $(TCFLAGS) -std=c++0x -isystem ${GTEST_DIR}/include -isystem ${GMOCK_DIR}/include server_test.cc server.cc server_config.cc config_parser.cc request_handler.cc ${GMOCK_DIR}/src/gmock_main.cc libgtest.a libgmock.a $(LIBFLAGS) -o server_test

request_handler_test:
	$(CC) $(TCFLAGS) -std=c++0x -isystem ${GTEST_DIR}/include request_handler_test.cc server_config.cc config_parser.cc request_handler.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LIBFLAGS) -o request_handler_test

server_config_test:
	$(CC) $(TCFLAGS) -std=c++0x -isystem ${GTEST_DIR}/include server_config_test.cc server.cc config_parser.cc request_handler.cc server_config.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a $(LIBFLAGS) -o server_config_test
