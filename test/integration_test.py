...
send_request('http://localhost:8011/echo', echo)
# Test longest prefix mapping: 
send_request('http://localhost:8011/echo/test', echo_test)
send_request('http://localhost:8011/static1/hello.html', static)
send_request('http://localhost:8011/static1/missing', bad)
